...
const Perguntas = () => { 
  ...
  const materias = [
    ...
    },
    {
      ...
      imagem: './public/probabilidade.jpg',
    },
  ];
        ...
        <div className="bemVindo">
          {paginaAtual === -1 ? ( 
            <div className="bemVindo">
              ...
              <img src="./public/UniBrain.png" alt="Logo do UniBrain" className="logoSite" />
